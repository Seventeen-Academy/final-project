              ...
              <div className="row col-rev">
                ...
                <section className="complete-course bgr-light shadow-sm rounded p-4 ">
                  <div className="row md-4">
                    ...
                    <div className="card d-flex flex-row py-0 px-3" style={{ width: '180px' }}>
                      <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="my-auto">
                        <path d="M0.701172 5V3H2.92339V2C2.92339 1.46957 3.15752 0.960859 3.57427 0.585786C3.99102 0.210714 4.55625 0 5.14562 0H11.8123V7L14.5901 5.5L17.3678 7V0H18.479C19.6456 0 20.7012 0.95 20.7012 2V18C20.7012 19.05 19.6456 20 18.479 20H5.14562C3.97895 20 2.92339 19.05 2.92339 18V17H0.701172V15H2.92339V11H0.701172V9H2.92339V5H0.701172ZM5.14562 9H2.92339V11H5.14562V9ZM5.14562 5V3H2.92339V5H5.14562ZM5.14562 17V15H2.92339V17H5.14562Z" fill="#3E37A9"/>
                        </svg>
                        <div className="card-body card-body-sm py-0 tex-center mt-2">
